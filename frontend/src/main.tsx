...
function App() {
  ...
  return <main>
    <header className="topbar"><div><p className="eyebrow">RECOVERGUARD / TEST MODE</p><h1>Recover revenue without unsafe retries.</h1><p className="lede">A policy-constrained operations console. Every treatment is explainable, revalidated, and auditable.</p></div><div className="status-stack"><span className="badge badge-live">Policy engine active</span><span className="mode-label">Real gateway calls are Test Mode only</span></div></header>
